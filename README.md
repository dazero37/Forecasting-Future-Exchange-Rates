...
> - 최근 환율 변동성이 커지며 예측이 어려워진 상황에서 정부와 기업 모두 선제적 대응에 한계를 겪고 있습니다.
> - 이에 경제 주체별 환율 영향 요인, 이벤트 스터디 등을 분석하여 본 프로젝트를 수행하였습니다.
...
> 2. 글로벌 금융 위기 (2008.09 - 2009.03)
> 3. 코로나 팬데믹 (2020.03 - 2021.06)
> 4. 자이언트 스텝 (2022.03 - 2023.07)
...
## 🔜 방향성 제시 (고급 예측)
1. 기업
> 수입단가 리스크를 사전에 예측하고 대응할 수 있도록 설계된 시스템으로, <br>
...
2. 정부
> 환율 변동률(volatility)을 기반으로 위험 임계치를 넘으면 금융위기 가능성을 조기 경고하는 시스템
- 예측 과정
